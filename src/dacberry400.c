        ...
        struct snd_soc_dapm_context *dapm, enum snd_soc_bias_level level)
{
	...
	aic3x = snd_soc_component_get_drvdata(component);
		...
		snd_soc_component_write(component, HPLCOM_CFG, hpcom_reg | 0x20);//E0 previous value

		snd_soc_component_write(component, LINE1R_2_RADC_CTRL, 0x04);//reg 22: MIC1RP/LINE1RP to Right-ADC Control Register
		snd_soc_component_write(component, LINE1L_2_LADC_CTRL, 0x04);//reg 19: MIC1LP/LINE1LP to Left-ADC Control Register
		...
		snd_soc_component_write(component, LINE1R_2_RADC_CTRL, 0x00);//reg 22: MIC1RP/LINE1RP to Right-ADC Control Register
		snd_soc_component_write(component, LINE1L_2_LADC_CTRL, 0x00);//reg 19: MIC1LP/LINE1LP to Left-ADC Control Register
					   ...
					   struct snd_pcm_hw_params *params)
{
	...
	case 48000:
        ...
        default:
                ...
                "Failed to set SYSCLK, unsupported samplerate %d\n",
                samplerate);
        }
